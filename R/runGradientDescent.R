...
runGradientDescent <- function(L0r10, R0r10, lambda, epochs,
                   eps=0.01, block, N, nnzis, nnzjs, is, js, D, m , n, r) {
  ...
  for (epoch in seq_len(epochs)) {
    flog.debug(paste("Calculating gradient descent epoch", epoch, "of", epochs,  
                     "for block", block))
