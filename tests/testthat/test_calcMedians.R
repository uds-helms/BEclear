testthat::context("Testing the caculations of Medians for all batches")
...
testthat::test_that("2 batches, only available values",{
    ...
    res1<-calcMedians(samples = samples, data = data)
...
testthat::test_that("3 batches, NAs",{
    ...
    testthat::expect_equal(res1[,2], c(-1.578 ,0.577, 0.621), tolerance = .001)
    testthat::expect_equal(res1[,3], c(0.564, NA, -1.039), tolerance = .001)
}
)