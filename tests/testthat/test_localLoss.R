...
testthat::test_that("long error matrix, only integer values given",{
    ...
    testthat::expect_equal(res1$dL, matrix(c(61, 39)), tolerance = .01)
    testthat::expect_equal(res1$dR, t(matrix(c(65, 21, 0))), tolerance = .01)
}
)
...
testthat::test_that("wide error matrix, only integer values given",{
    ...
    testthat::expect_equal(res1$dL, matrix(c(48, 27, 0)), tolerance = .01)
    testthat::expect_equal(res1$dR, t(matrix(c(31, 58))), tolerance = .01)
}
)