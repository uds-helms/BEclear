...
testthat::test_that("long D matrix, only integer values given",{
    ...
    testthat::expect_equal(res1$L, matrix(c(-0.30, -1.044)), tolerance = .01)
    testthat::expect_equal(res1$R, t(matrix(c(-0.268, -0.476, 8.000))), tolerance = .01)
}
)
...
testthat::test_that("wide D matrix, only integer values given",{
    ...
    testthat::expect_equal(res1$L, matrix(c(4.14, 1.176, 2.00)), tolerance = .01)
    testthat::expect_equal(res1$R, t(matrix(c(2.05, 2.59))), tolerance = .01)
}
)